...
An example of real \texttt{csv} and resulted \texttt{lexd} fragments are shown in Code block \ref{code:6_1}. I decided to keep meanings from the source as \texttt{lexd} comments. This should not influence the compilation process, and later it makes it easier to debug lexicons manually.